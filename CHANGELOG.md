...
### Other Changes
- your rules are listed alphabetically by name, so one can be found in a long list. The up and down arrows are gone from the rule lists — the order no longer decides anything. A rule you have just added stays at the end until you give it a name, and the list does not reshuffle while you are typing
