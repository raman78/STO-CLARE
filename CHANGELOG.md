...
- the Name column orders the rows too, A to Z and back — in the main window's tables, in the Summary tab's player list and in a comparison. Looking for an ability you know the name of no longer means reading down a list ordered by size
