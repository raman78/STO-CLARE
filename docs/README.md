...
| `BUILD_DIFF.md`           | Design only, not built: turning a comparison of runs into a verdict on which build is ahead, and why the program may state effects but never causes. |
